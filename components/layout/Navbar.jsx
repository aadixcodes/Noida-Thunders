...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-[#fab505] font-[Para-1]">
      {/* Top Section */}
      <div className="w-full hidden md:flex flex-row lg:flex-row items-center justify-between px-6 lg:px-10 py-4 gap-4 lg:gap-0">
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-7 text-sm">
